...
```
cd existing_repo
git remote add origin https://gitlab.com/l2693/frontend/prototipo-de-pantalla-v3.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/l2693/frontend/prototipo-de-pantalla-v3/-/settings/integrations)
...
https://community.listopro.com/integra-firebase-con-vue-3/
